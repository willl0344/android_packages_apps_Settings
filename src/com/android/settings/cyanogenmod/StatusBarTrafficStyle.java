...
public class StatusBarTrafficStyle extends SettingsPreferenceFragment implements
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.status_bar_traffic_style);

        prefs = getPreferenceScreen();

        mStatusBarTrafficColor = (ColorPickerPreference) findPreference(PREF_STATUS_BAR_TRAFFIC_COLOR);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.status_bar_traffic_style, menu);
    } 
